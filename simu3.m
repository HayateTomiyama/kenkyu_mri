function [chem]=simu3(MATRIX,P,Q,R,ppm_diff_P,ppm_diff_Q,ppm_diff_R,ta,delta_t,initial_phase,delta_B_rate,abs_noise_max)
%IDEAL3分子分離シミュレーション
%P,Q,Rは強度　〇 * 10^4 の丸の部分を入力
...
chem = IDEAL(ta,delta_t,0,3,ppm_diff_Q,ppm_diff_R,A,B,C,D);
